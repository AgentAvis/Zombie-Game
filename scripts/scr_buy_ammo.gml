...
ammoMouseVar[argument3] = point_in_rectangle(window_x,window_y,argument0 - 4.1 * sprite_get_width(s_guns_ammo)/2,argument1 -  4.1 * sprite_get_height(s_guns_ammo)/2,argument0 + 4.1 * sprite_get_width(s_guns_ammo)/2,argument1 + 4.1 * sprite_get_height(s_guns_ammo)/2);
