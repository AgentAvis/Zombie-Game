...
draw_text((argument0 + 59) * GUISCALE_X, (argument1 + 32) * GUISCALE_Y,"x" + string(argument4));
draw_set_color(c4)
...
draw_set_color(c_black);
draw_text((argument0 + ((gbWidth + 277)/2)) * GUISCALE_X, (argument1 + ((gbHeight + 8)/2)) * GUISCALE_Y, "$" + string(argument3));
draw_set_color(c3);
...
draw_set_color(c_black);
draw_set_halign(fa_center);
draw_text((argument0 + 157) * GUISCALE_X, (argument1 + 51) * GUISCALE_Y, string(argument5));
draw_set_halign(fa_left);
